...
Asena.addCommand({pattern: 'm1', fromMe: true}, (async (message, match) => {

    await message.sendMessage("╱▔▔╲╱▔▔╲\n▏┈╭╮╭╮┈▕ \n╲┈┏━━┓┈╱\n   ╲╰━━╯╱\n     ╲┈┈╱\n        ╲╱\n        🌷\n   ◢▇◣◢▇◣\n   ▇▇▇▇▇▇\n   ◥▇▇▇▇◤\n      ◥▇▇◤\n        ◥◤\n       🌷\n🔮🌹🍃🌹🍃🔮\n(¯•.•´¯) (¯•.•´¯)\n~•.¸(¯•.•´¯)¸ .•~\n×°× ` •.¸.•´ ×°×\n ˏ.٠•☼ • •·)\n ˙·٠•●•٠·˙ \n˙·٠•●•٠·˙☼✫ ღ 彡 \n♡ ➹ ᶫᵒᵛᵉ 彡 \n┊┊┊\n┊┊★\n┊★\n★");

}));

Asena.addCommand({pattern: 'm2', fromMe: true}, (async (message, match) => {

    await message.sendMessage("┏🌷️┓┏🌷️┓┏🌷️┓\n┗🌷️┛┗🌷️┛┗🌷┛\n☆°🍃🌸 *Seni seviyorum* 💕 \n☆°🍃🌸\n☆°🍃🌸\n☆°🍃‍🌸\n☆°🍃‍🌸\n☆°🍃‍🌸\n☆°🍃🌸️\n☆°🍃🌸 *Sen de beni seviyor musun?* 🥰\n┏🌷️┓┏🌷️┓┏🌷️┓\n┗🌷️┛┗🌷️┛┗🌷┛\n☆°🍃🌸\n☆°🍃🌸\n☆°🍃🌸\n☆°🍃‍🌸\n☆°🍃‍🌸\n☆°🍃‍🌸\n☆°🍃🌸️\n☆°🍃🌸");

}));

Asena.addCommand({pattern: 'm3', fromMe: true}, (async (message, match) => {

    await message.sendMessage("🌹🍃 *İyi* \n┆🍃\n┆🌼\n┆┆🍃\n┆┆🌷\n┆┆┆🍃\n┆┆┆🌹\n┆┆┆┆\n┆┆┆┆\n┆┆┆┆\n┆┆┆🌹 *Geceler* \n┆┆┆┆🍃\n┆┆┆🌹\n┆┆┆🍃\n┆┆🌷\n┆┆🍃\n┆🌼\n┆🌹🍃\n🌹🍃\n┆🍃\n┆🌼\n┆┆🍃\n┆┆🌷 *Tatlı* \n┆┆┆🍃\n┆┆┆🌹\n┆┆┆┆\n┆┆┆┆\n┆┆┆┆\n┆┆┆🌹 *Rüyalar* \n┆┆┆┆🍃\n┆┆┆🌻\n┆┆┆🍃\n┆┆🌷\n┆┆🍃\n┆🌼\n┆🌹🍃\n🌹🍃\n");

}));

Asena.addCommand({pattern: 'm4', fromMe: true}, (async (message, match) => {

    await message.sendMessage("🌷🌷🌷🌷🌷🌷\n🌷█▒▒▒▒▒▒▒▒▒█🌷🍃\n 🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n 🍃 *Gecen de senin gibi* 🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n 🍃🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n🍃🌸🌸🌸🌸🌸🌸🍃\n🍃🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷🍃\n🍃🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n🍃 *Güzel olsun. Tatlı Rüyalar* 🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n🍃 🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n  🌷🌷🌷🌷🌷🌷");

}));

Asena.addCommand({pattern: 'm5', fromMe: true}, (async (message, match) => {

    await message.sendMessage("💚 *Günün aydın* 💚\n   💚 *Olsun* 💚\n  ===>♡☕️☕️♡<===\n        ┈┈╭╯╯╯┈\n     ┈┈┏━━━━┓\n     ┈╭┫╭▅╭▅┃\n     ┈┃┃┳╭╮┳┃\n     ┈╰┫╰━━╯┃\n     ▔▔╰━━━━╯\n🌸 *Bu çay senin için* 🌸\n🌸 *Günün güzel geçsin* 🌸");

}));

Asena.addCommand({pattern: 'm6', fromMe: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'enm1', fromMe: true}, (async (message, match) => {

    await message.sendMessage("╱▔▔╲╱▔▔╲\n▏┈╭╮╭╮┈▕ \n╲┈┏━━┓┈╱\n   ╲╰━━╯╱\n     ╲┈┈╱\n        ╲╱\n        🌷\n   ◢▇◣◢▇◣\n   ▇▇▇▇▇▇\n   ◥▇▇▇▇◤\n      ◥▇▇◤\n        ◥◤\n       🌷\n🔮🌹🍃🌹🍃🔮\n(¯•.•´¯) (¯•.•´¯)\n~•.¸(¯•.•´¯)¸ .•~\n×°× ` •.¸.•´ ×°×\n ˏ.٠•☼ • •·)\n ˙·٠•●•٠·˙ \n˙·٠•●•٠·˙☼✫ ღ 彡 \n♡ ➹ ᶫᵒᵛᵉ 彡 \n┊┊┊\n┊┊★\n┊★\n★");

}));

Asena.addCommand({pattern: 'enm2', fromMe: true}, (async (message, match) => {

    await message.sendMessage("┏🌷️┓┏🌷️┓┏🌷️┓\n┗🌷️┛┗🌷️┛┗🌷┛\n☆°🍃🌸 *I Love You* 💕 \n☆°🍃🌸\n☆°🍃🌸\n☆°🍃‍🌸\n☆°🍃‍🌸\n☆°🍃‍🌸\n☆°🍃🌸️\n☆°🍃🌸 *Do you love me too?* 🥰\n┏🌷️┓┏🌷️┓┏🌷️┓\n┗🌷️┛┗🌷️┛┗🌷┛\n☆°🍃🌸\n☆°🍃🌸\n☆°🍃🌸\n☆°🍃‍🌸\n☆°🍃‍🌸\n☆°🍃‍🌸\n☆°🍃🌸️\n☆°🍃🌸");

}));

Asena.addCommand({pattern: 'enm3', fromMe: true}, (async (message, match) => {

    await message.sendMessage("🌹🍃 *Good* \n┆🍃\n┆🌼\n┆┆🍃\n┆┆🌷\n┆┆┆🍃\n┆┆┆🌹\n┆┆┆┆\n┆┆┆┆\n┆┆┆┆\n┆┆┆🌹 *Night* \n┆┆┆┆🍃\n┆┆┆🌹\n┆┆┆🍃\n┆┆🌷\n┆┆🍃\n┆🌼\n┆🌹🍃\n🌹🍃\n┆🍃\n┆🌼\n┆┆🍃\n┆┆🌷 *Sweet* \n┆┆┆🍃\n┆┆┆🌹\n┆┆┆┆\n┆┆┆┆\n┆┆┆┆\n┆┆┆🌹 *Dreams* \n┆┆┆┆🍃\n┆┆┆🌻\n┆┆┆🍃\n┆┆🌷\n┆┆🍃\n┆🌼\n┆🌹🍃\n🌹🍃\n");

}));

Asena.addCommand({pattern: 'enm4', fromMe: true}, (async (message, match) => {

    await message.sendMessage("🌷🌷🌷🌷🌷🌷\n🌷█▒▒▒▒▒▒▒▒▒█🌷🍃\n  🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n 🍃 *May your night be perfect* 🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n 🍃🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n🍃🌸🌸🌸🌸🌸🌸🍃\n🍃🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷🍃\n🍃🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n🍃 *Like You. Sweet Dreams* 🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n🍃 🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n  🌷🌷🌷🌷🌷🌷");

}));

Asena.addCommand({pattern: 'enm5', fromMe: true}, (async (message, match) => {

    await message.sendMessage("💚 *Good* 💚\n   💚 *Morning* 💚\n  ===>♡☕️☕️♡<===\n        ┈┈╭╯╯╯┈\n     ┈┈┏━━━━┓\n     ┈╭┫╭▅╭▅┃\n     ┈┃┃┳╭╮┳┃\n     ┈╰┫╰━━╯┃\n     ▔▔╰━━━━╯\n🌸 *This coffee is for you* 🌸\n🌸 *Have a nice day* 🌸");

}));

Asena.addCommand({pattern: 'enm6', fromMe: true}, (async (message, match) => {
